...
// // first attempt
// bill >= 50 && bill <= 300 ? console.log(`The bill was ${bill}, the tip was ${bill * .15} and the total value is ${(bill * .15)+bill}`) :
// console.log(`The bill was ${bill}, the tip was ${bill * .20} and the total value is ${(bill * .20)+bill}`);
// //final attempt
